import { Game, GameSchema, Stats, StatsSchema } from "../models/game";
...
export class FirestoreRestService {
  ...
  constructor(env: any) {
    ...
    if (!this.projectId || !this.apiKey) {
      throw new Error("Missing required Firebase configuration: FIREBASE_PROJECT_ID and FIREBASE_API_KEY must be set");
    }
