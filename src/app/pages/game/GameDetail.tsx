...
export async function GameDetail({ ctx, params }: RequestInfo) {
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div>
            {game.players.map((player) => (
              <PlayerComponent key={player.uid} player={player} />
            ))}
          </div>
        </div>
        ...
        <div style={{ 
          ...
          {game.missions.map((mission, index) => {
            ...
            return (
              <MissionComponent key={index} mission={mission} missionNumber={index + 1}>
